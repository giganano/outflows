...
# take procedurally generated input
from . import nonmetal_inputs
vice.primordial["he"] = nonmetal_inputs.PRIMORDIAL_HE4
vice.primordial["au"] = nonmetal_inputs.PRIMORDIAL_HE3
YIELDSOLAR = nonmetal_inputs.YIELDSOLAR
print("Primordial helium-4 by mass: ", vice.primordial["he"])
print("Primordial helium-3 by mass: ", vice.primordial["au"])
print("Solar yield scale: ", YIELDSOLAR)

# inputs for non-metal isotopes paper
# from .yields import YIELDSOLAR
