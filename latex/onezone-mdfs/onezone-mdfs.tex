...
% \newpage
% \begin{equation}
% f = \frac{(R + v_R \Delta t)^2 - R^2}{(R + \Delta R)^2 - R^2}
% \end{equation}
% \par\null\par
% \begin{equation}
% \text{[$\alpha$/H]} = A(R - R_\odot) \implies Z_\alpha = Z_{\alpha,\odot}
...
% \\
% Z_\alpha(R + \Delta R) &\approx Z_\alpha(R) +
% \frac{\partial Z_\alpha}{\partial R} \Delta R
% \\
...
% \begin{subequations}
% \begin{align*}
% \dot{M}_{\alpha,\text{flow}} &= Z_\alpha(R) M_g(R) \frac{f(R)}{\Delta t}
% \left[
% \left(
% 1 + \frac{1}{Z_\alpha(R)}\frac{\partial Z_\alpha}{\partial R}\Delta R
% \right)
% \left(
% 1 + \frac{1}{M_g(R)}\frac{\partial M_g}{\partial R}\Delta R
% \right)
% \left(
% 1 + \frac{1}{f(R)}\frac{\partial f}{\partial R}\Delta R
% \right)
% - 1
% \right]
% \\
% &\lim_{\Delta R,\Delta t \rightarrow 0} \dot{M}_{\alpha,\text{flow}} =
% Z_\alpha M_g v_R \left(\frac{1}{R} - \frac{1}{R_g} - \frac{1}{R_\alpha}\right) =
...
% \par\null\par
% \begin{subequations}\begin{align}
% \mu_\text{flow} &\equiv \tau_\star v_R \left(\frac{1}{R} - \frac{1}{R_g} -
% \frac{1}{R_\alpha}\right)
% \\
% \gamma_\text{flow} &\equiv \tau_\star v_R \left(\frac{1}{R} - \frac{1}{R_g}
% \right)
% \\
% \dot{M}_{\alpha,\text{flow}} &= Z_\alpha \dot{M}_\star \mu_\text{flow}
% \\
% \dot{M}_\text{gas,flow} &= \dot{M}_\star \gamma_\text{flow}
% \end{align}\end{subequations}
